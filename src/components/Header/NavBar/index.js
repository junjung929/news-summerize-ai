                    ...
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul className="nav navbar-nav">
                                ...
                                <li className={this.state.active ? "active" : " "}><Link to="/economy"><img src="./src/static/img/eco.png" alt="economy" /><span>ECONOMY</span></Link></li>
                                <li className={this.state.active ? "active" : " "}><Link to="/tech"><img src="./src/static/img/tech.png" alt="tech" /><span>TECHNOLOGY</span></Link></li>
                                <li className={this.state.active ? "active" : " "}><Link to="/sport"><img src="./src/static/img/sport.png" alt="sport" /><span>SPORT</span></Link></li>
                                <li className={this.state.active ? "active" : " "}><Link to="/search"><img src="./src/static/img/search.png" alt="search" /><span>SEARCH</span></Link></li>
